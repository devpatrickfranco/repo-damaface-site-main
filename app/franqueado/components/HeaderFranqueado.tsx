                ...
                <div className="flex items-center justify-between h-full px-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                      ...
                      {notificationsOpen && (
                        <div className="absolute right-0 top-12 w-80 bg-gray-800 rounded-lg shadow-lg border border-gray-700 py-2 z-50">
                    ...
                    <div className="relative">
                      ...
                      {profileDropdownOpen && (
                        <div className="absolute right-0 top-12 w-48 bg-gray-800 rounded-lg shadow-lg border border-gray-700 py-2 z-50">
                          ...
                          <hr className="my-2" />
                          <button onClick={logout} className="w-full px-4 py-2 text-left hover:bg-gray-700 flex items-center space-x-2 text-red-400">
