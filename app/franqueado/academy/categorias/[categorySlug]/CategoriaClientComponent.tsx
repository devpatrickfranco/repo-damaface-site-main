      ...
      <div className="flex pt-16 h-[calc(100vh-4rem)]">
        ...
        <main className="flex-1 p-8 ml-64 transition-all duration-300 overflow-y-auto">
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-lg">
                    {cursosCategoria.length} curso{cursosCategoria.length !== 1 ? "s" : ""} disponível
                    {cursosCategoria.length !== 1 ? "eis" : ""}
                  </p>
                </div>
              </div>
            ...
            {/* Filtros e Busca */}
            <div className="bg-dark-base/50 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-6 mb-8">
                ...
                {cursosCategoria.map((curso: any) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      {curso.descricao && <p className="text-gray-400 text-sm mb-4 line-clamp-2">{curso.descricao}</p>}
