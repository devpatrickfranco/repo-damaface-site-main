  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        className={`flex items-center gap-2 px-4 py-2.5 rounded-full transition-colors font-medium text-sm border ${isSelectionMode
      ...
      <div className="flex items-center bg-gray-800 rounded-full p-1 border border-gray-700">
        <button
          ...
          className={`p-2 rounded-full transition-colors ${viewMode === "grid" ? "bg-gray-700 text-brand-pink" : "text-gray-400 hover:text-white"
            }`}
        ...
        <button
          ...
          className={`p-2 rounded-full transition-colors ${viewMode === "list" ? "bg-gray-700 text-brand-pink" : "text-gray-400 hover:text-white"
            }`}
