...
import { Send, Sparkles, Film, ArrowLeft, RotateCcw, Loader2 } from 'lucide-react';
...
const GerarReelsPage = () => {
    ...
    const suggestedQuestions = [
        {
            icon: Film,
            text: 'Crie um roteiro de reels para divulgar um produto',
            category: 'Exemplo'
        },
        {
            icon: Sparkles,
            text: 'Sugira ideias de reels para redes sociais',
            category: 'Exemplo'
        },
        {
            icon: Film,
            text: 'Monte um storyboard para um reels institucional',
            category: 'Exemplo'
        },
        {
            icon: Sparkles,
            text: 'Crie legendas criativas para reels de promoção',
            category: 'Exemplo'
        }
    ];
    ...
    const handleSendMessage = async (messageText?: string) => {
        ...
        try {
            ...
            const reader = await apiBackend.stream('/marketing/gerar-reels/ai/chat/stream/', {
                message: textToSend,
            ...
            <div className="flex flex-col flex-1 max-w-5xl mx-auto w-full px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="p-2 bg-brand-pink/20 rounded-lg">
                                <Film className="w-6 h-6 text-brand-pink" />
                            </div>
                            <h1 className="text-3xl font-bold text-white">Gerar Reels com IA</h1>
                        </div>
                    ...
                    <p className="text-gray-400 text-sm ml-14">
                        Assistente de IA especializado em criar roteiros e conteúdo para reels
                    </p>
                </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center space-y-8 animate-fade-in">
                        <div className="text-center space-y-3 mb-8">
                            ...
                            <h2 className="text-2xl font-semibold text-white">
                                Que tipo de reels você quer criar?
                            </h2>
                            <p className="text-gray-400 max-w-md">
                                Descreva sua ideia e a IA vai ajudar a criar roteiros e conteúdo para seus reels
                            </p>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <div className="flex-1 relative">
                                <textarea
                                    ...
                                    placeholder="Descreva o tipo de reels que você quer criar..."
