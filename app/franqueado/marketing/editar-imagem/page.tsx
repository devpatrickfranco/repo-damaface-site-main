...
import { Send, Sparkles, Edit, ArrowLeft, RotateCcw, Loader2 } from 'lucide-react';
...
const EditarImagemPage = () => {
    ...
    const suggestedQuestions = [
        {
            icon: Edit,
            text: 'Remova o fundo de uma imagem',
            category: 'Exemplo'
        },
        {
            icon: Sparkles,
            text: 'Ajuste o brilho e contraste',
            category: 'Exemplo'
        },
        {
            icon: Edit,
            text: 'Redimensione uma imagem para redes sociais',
            category: 'Exemplo'
        },
        {
            icon: Sparkles,
            text: 'Aplique filtros e efeitos criativos',
            category: 'Exemplo'
        }
    ];
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center space-y-8 animate-fade-in">
                        <div className="text-center space-y-3 mb-8">
                            ...
                            <h2 className="text-2xl font-semibold text-white">
                                Como você quer editar sua imagem?
                            </h2>
